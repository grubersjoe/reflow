...
import { Comment, Decorator, File } from '@babel/types';
 ...
 * is lost after parsing. Babel has an option `retainLines`, but it is not
 * working as expected and will produce broken syntax in some cases. Neither
 * will Prettier help here, because it does not add additional blank lines:
 *
...
/**
 * Format the code generated by Babel by executing Prettier multiple times,
 * inserting blank lines and copying comments from the original source to the
 * output.
 */
